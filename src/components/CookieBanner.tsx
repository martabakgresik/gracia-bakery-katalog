...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[60] bg-white dark:bg-stone-900 border-t-2 border-primary dark:border-primary-light p-6 shadow-lg transition-colors duration-300">
